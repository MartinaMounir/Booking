...
<div class="row" style="margin: 10px">
    <div class="col-10">
        <h4 class="fw-bold  "><span class="text-muted fw-light">Stays /</span> Edit</h4>
    </div>
    <div class="col-2  ">
    ...
    <form method="POST" action="{{route('vendor.vendor.update',$stay->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <!-- Booking Start -->
            ...
            <div class="container">
                <div class="booking p-5">
                    <div class="row g-5 align-items-center">
                        ...
                        <div class="col-md-12">
                            <h1 class="text-white mb-4  text-center">Edit Stays</h1>
                            <form>
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <div class="form-floating">

                                            <input type="text" value="{{$stay->title}}" class="form-control bg-transparent" id="title"  name="title"  required autofocus   >
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            ...
                                            <input type="text" class="form-control bg-transparent" id="description"  name="description" value="{{$stay->description}}" required autofocus  ></input>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            ...
                                            <input id="numberofrooms" class="form-control bg-transparent" type="number" name="numberofrooms" value="{{$stay->numberofrooms}}" required   >
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <select id="largeSelect" name="available" class="form-control bg-transparent" >
                                                <option value="3">Choose available</option>
                                                <option value="0" @if ($stay->available== 0) selected @endif>available</option>
                                                <option value="1" @if ($stay->available == 1) selected @endif>unavailable</option>
                                            </select>
                                        ...
                                        <div class="form-floating">
                                            @if($stay->image1)
                                                <div class="form-floating mb-3">
                                                    <img src="{{asset('/storage/stays/'.$stay->image1)}}" width="200px">
                                                </div>
                                            @endif
                                            <input
                                                type="file"
                                    ...
                                    <div class="col-md-12">
                                        @if($stay->image2)
                                            <div class="form-floating mb-3">
                                                <img src="{{asset('/storage/stays/'.$stay->image2)}}" width="200px">
                                            </div>
                                        @endif
                                        <div class="form-floating">
                                            <input
                                    ...
                                    <div class="col-md-12">
                                        @if($stay->image3)
                                            <div class="form-floating mb-3">
                                                <img src="{{asset('/storage/stays/'.$stay->image3)}}" width="200px">
                                            </div>
                                        @endif
                                        <div class="form-floating">
                                            <input
                                    ...
                                    <div class="col-md-12">
                                        @if($stay->image4)
                                            <div class="form-floating mb-3">
                                                <img src="{{asset('/storage/stays/'.$stay->image4)}}" width="200px">
                                            </div>
                                        @endif
                                        <div class="form-floating">
                                            <input
                                        ...
                                        <div class="form-floating">
                                            <select id="country_id" name="country_id" class="form-select form-select-lg">
                                                ...
                                                @foreach($countries as $country)
                                                     <option value="{{$country->id}}"{{$stay->country_id==$country->id ? 'selected' : ''}}>{{$country->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            ...
                                            <input type="text" class="form-control bg-transparent" id="address"  name="address" value="{{$stay->address}}" required autofocus   >
